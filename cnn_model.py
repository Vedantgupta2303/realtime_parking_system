...
epochs = 30 # The number of iterations on which to train the model
...
checkpoint = ModelCheckpoint("car2.h5", monitor='val_acc', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
